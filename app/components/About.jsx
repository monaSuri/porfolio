    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className='flex-1 w-full px-4 md:px-0'>
            <p className='mb-6 md:mb-10 md:text-base max-w-full md:max-w-3xl text-justify font-Ovo'>
            ...
            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full md:w-3/4 lg:w-3/3'>
                {infoList.map (({icon, iconDark, title, description_1, description_2}, index) => (
                <li key={index} className='
                border-[0.5px] border-gray-400 rounded-xl p-4 sm:p-6
            ...
            <h3 className='my-4 sm:my-6 sm:text-base text-gray-500 font-Ovo'> Languages I'm comfortable with, </h3>

            <ul className='flex flex-wrap gap-2 sm:gap-5'>
                {languageData.map((tool, index)=>(
                  <li className='flex flex-wrap items-center justify-center w-12 sm:w-14 aspect-square border
